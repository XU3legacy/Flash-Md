...
france(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        if (!arg || arg.length === 0)  {
            const lien = 'https://telegra.ph/file/3b7b7e9ef863b43615534.jpg';
            const msg = `*𝔽𝕀ℂℍ𝔼 𝔻𝕌 𝕁𝕆𝕌𝔼𝕌ℝ*
     𝕞𝕒𝕥𝕣𝕚𝕔𝕦𝕝𝕖: *+NEJ88sA*
*ℕ•*: 014
▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨
...
france(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        if (!arg || arg.length === 0)  {
            const lien = 'https://telegra.ph/file/d4f16885e4b8bcb6452c2.jpg';
            const msg = `*𝔽𝕀ℂℍ𝔼 𝔻𝕌 𝕁𝕆𝕌𝔼𝕌ℝ*
     𝕞𝕒𝕥𝕣𝕚𝕔𝕦𝕝𝕖: *+KAM90sA*
*ℕ•*: 016
▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨
...
france(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        if (!arg || arg.length === 0)  {
            const lien = 'https://telegra.ph/file/f2fe510eecc0dfe4bfe82.jpg';
            const msg = `*𝔽𝕀ℂℍ𝔼 𝔻𝕌 𝕁𝕆𝕌𝔼𝕌ℝ*
     𝕞𝕒𝕥𝕣𝕚𝕔𝕦𝕝𝕖: *+ZEG23sA*
*ℕ•*: 015
▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨
...
france(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        if (!arg || arg.length === 0)  {
            const lien = 'https://telegra.ph/file/065e904a9ba17337e997d.jpg';
            const msg = `*𝔽𝕀ℂℍ𝔼 𝔻𝕌 𝕁𝕆𝕌𝔼𝕌ℝ*
     𝕞𝕒𝕥𝕣𝕚𝕔𝕦𝕝𝕖: *+MIH50sC*
*ℕ•*: 016
▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨
...
france(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        if (!arg || arg.length === 0)  {
            const lien = 'https://telegra.ph/file/c2bbb321cd8a35ad42543.jpg';
            const msg = `*𝔽𝕀ℂℍ𝔼 𝔻𝕌 𝕁𝕆𝕌𝔼𝕌ℝ*
     𝕞𝕒𝕥𝕣𝕚𝕔𝕦𝕝𝕖: *+YNN24sD*
*ℕ•*: 017
▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨
...
france(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        if (!arg || arg.length === 0)  {
            const lien = 'https://telegra.ph/file/44c6aad75a079d32ef6c1.jpg';
            const msg = `*𝔽𝕀ℂℍ𝔼 𝔻𝕌 𝕁𝕆𝕌𝔼𝕌ℝ*
     𝕞𝕒𝕥𝕣𝕚𝕔𝕦𝕝𝕖: *-NAV08bA*
*ℕ•*: 019
▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨▨
